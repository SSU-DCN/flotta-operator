...
func (in *EdgeDeviceSpec) DeepCopyInto(out *EdgeDeviceSpec) {
	*out = *in
	...
	if in.WirelessDevices != nil {
		...
		*out = make([]*WirelessDevice, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(WirelessDevice)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WirelessDevice) DeepCopyInto(out *WirelessDevice) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WirelessDevice.
func (in *WirelessDevice) DeepCopy() *WirelessDevice {
	if in == nil {
		return nil
	}
	out := new(WirelessDevice)
