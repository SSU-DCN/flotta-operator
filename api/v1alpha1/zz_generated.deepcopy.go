...
func (in *Hardware) DeepCopyInto(out *Hardware) {
	*out = *in
	...
	if in.ConnectedWirelessDevices != nil {
		in, out := &in.ConnectedWirelessDevices, &out.ConnectedWirelessDevices
		*out = make([]*WirelessDeviceInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(WirelessDeviceInfo)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WirelessDeviceInfo) DeepCopyInto(out *WirelessDeviceInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WirelessDeviceInfo.
func (in *WirelessDeviceInfo) DeepCopy() *WirelessDeviceInfo {
	if in == nil {
		return nil
	}
	out := new(WirelessDeviceInfo)
